...
CLASS_NAME_TO_NUMBER = {
    'creche': 1, 'nursery 1': 2, 'nursery 2': 3, 'kg 1': 4, 'kg1': 4, 'kg 2': 5, 'kg2': 5,
    'class 1': 6, 'class1': 6, 'class 2': 7, 'class2': 7, 'class 3': 8, 'class3': 8,
    'class 4': 9, 'class4': 9, 'class 5': 10, 'class5': 10, 'class 6': 11, 'class6': 11,
    'jhs 1': 12, 'jhs1': 12, 'jhs 2': 13, 'jhs2': 13, 'jhs 3': 14, 'jhs3': 14,
}
...
def import_students_from_excel():
    ...
    for index, row in df.iterrows():
        ...
        if user:
            ...
            user.save()
            created_count += 1
            print(f"Created {user.full_name} with ID {user.user_id} and PIN {password}")
        ...
        try:
            ...
            print(f"StudentProfile for {user.full_name} not found!")

    return f"Import completed: {created_count} created, {updated_count} updated."
